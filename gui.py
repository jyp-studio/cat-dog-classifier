...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.labelImg.setGeometry(QtCore.QRect(330, 30, 224, 224))
        self.labelImg.setObjectName("labelImg")
        self.labelPredict = QtWidgets.QLabel(self.centralwidget)
        self.labelPredict.setGeometry(QtCore.QRect(400, 260, 100, 32))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn5_1.setText(_translate("MainWindow", "1. Show Images"))
        self.btn5_2.setText(_translate("MainWindow", "2. Show Destribution"))
        self.btn5_3.setText(_translate("MainWindow", "3. Show Model Structure"))
        self.btn5_4.setText(_translate("MainWindow", "4. Show Comparison"))
